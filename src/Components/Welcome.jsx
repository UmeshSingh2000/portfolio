    ...
    <div className="w-full h-full bg-black text-white font-mono overflow-hidden px-6 py-8">
      <div className="max-w-3xl text-sm space-y-3 leading-relaxed">
        ...
        <p className="text-gray-400">
          Tip: Click on <code className="bg-gray-800 px-1 rounded">Projects Files</code> or <code className="bg-gray-800 px-1 rounded">Documents</code> from the sidebar to explore.
        </p>
